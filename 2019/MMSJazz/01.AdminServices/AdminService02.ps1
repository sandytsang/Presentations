...
$clientId = "402daf63-7115-4a87-883e-2ad83c3143c2" #Change this to your cloud service native app ID
$Username = "sccmadmin1@smsboot.com" #Change this to your username
$Password = "MMSJazz" #Change this to your password
...
$url = "HTTPS://CONFIGMGRCMG001.SMSBOOT.COM/CCM_Proxy_ServerAuth/72057594037927941/AdminService/wmi/SMS_Package?`$filter=Name eq 'BIOS Update - Lenovo ThinkPad P1'"
