...
$authToken = Get-MSIntuneAuthToken -TenantName "8cfbf3fe-35a7-482f-ab0a-32e5f5109225" -ClientID "6ed98779-af2a-41a2-be63-a7374c611e8b" -Resource "https://ConfigMgrServiceCB" -PromptBehavior Always

$authToken.Authorization

$url = "https://mycmg.smsboot.com/CCM_Proxy_ServerAuth/72057594037927941/AdminService/wmi/SMS_R_User"
